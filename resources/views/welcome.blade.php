		...
		<div class="rounded-3 p-3 p-sm-5" style="background-image: url(assets/images/bg/01.jpg); background-position: center center; background-repeat: no-repeat; background-size: cover;">
			...
			<div class="row">
                <div class="max-w-4xl mx-auto text-center">
                    <h1 class="text-blue-500 text-2xl sm:text-3xl lg:text-4xl pt-5 my-5">
                        <span class="block text-white text-base">Nos Offres</span>
                        <span class="block text-blue-500 text-lg">
                            Trouvez votre destination et partagez la route avec Easy-Way ?
                        </span>
                    </h1>
                </div>
            </div>
